...
export const metadata: Metadata = {
  title: "About / Meet Ricky",
  description: "Meet Ricky Bolan, owner of Bolan Septic Service — family-owned and operated in Aberdeen, WA since 2000.",
};
...
export default function AboutPage() {
  return (
    <div>
      ...
      <section className={styles.bio}>
        <div className={styles.bioInner}>
          <div className={styles.portraitCol}>
            <PhotoPlaceholder hint="Photo of Ricky Bolan" className={styles.portrait} />
          </div>
          <div className={styles.copyCol}>
            <div className={styles.eyebrow}>About Us</div>
            <h1 className={styles.h1}>Meet Ricky Bolan</h1>
            <p className={styles.p}>
              Ricky Bolan founded Bolan Septic Service in 2000, running it the way he&apos;d want it run for his own
            ...
            <p className={styles.pLast}>
              ...
              national franchise, no subcontracted crews. Just Ricky and a small local team serving the same
      ...
      <CtaBand heading="Talk to Ricky's Team Today" />
      <Footer />
    </div>
  );
}
